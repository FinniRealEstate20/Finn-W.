...
export const mockBroker: Broker = {
  id: 'thomas-k',
  name: 'Thomas Kühn',
  company: 'Kühn Immobilien Osnabrück',
  city: 'Osnabrück',
  email: 'thomas@kuehn-immobilien-os.de',
  ...
  brandColor: '#0469c4',
  googleReviewUrl: 'https://g.page/r/kuehn-immobilien-osnabrueck/review',
  reviews: {
    total: 18,
    average: 4.9,
    requestsSent: 28,
...
const julia: Buyer = (() => {
  ...
  return {
    ...
    propertyType: 'ownUse',
    city: 'Osnabrück',
    address: 'Neuer Graben 5, 49074 Osnabrück-Innenstadt',
    oldAddress: 'Hasestraße 60, 49074 Osnabrück',
...
const lukas: Buyer = (() => {
  ...
  return {
    ...
    city: 'Osnabrück',
    address: 'Sutthauser Straße 12, 49080 Osnabrück-Wüste',
    oldAddress: 'Möserstraße 22, 49074 Osnabrück',
...
const sabine: Buyer = (() => {
  ...
  return {
    ...
    city: 'Osnabrück',
    address: 'Nelson-Mandela-Straße 3, 49076 Osnabrück-Westerberg',
    oldAddress: 'Bramscher Straße 100, 49088 Osnabrück-Haste',
...
export const topCurators: readonly TopCurator[] = [
  ...
  { rank: 2, name: 'Thomas Kühn', company: 'Kühn Immobilien Osnabrück', points: 4 },
